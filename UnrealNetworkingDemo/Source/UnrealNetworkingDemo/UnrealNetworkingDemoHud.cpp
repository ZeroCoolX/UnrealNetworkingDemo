...
AUnrealNetworkingDemoHud::AUnrealNetworkingDemoHud()
{
	static ConstructorHelpers::FObjectFinder<UFont> Font(TEXT("/Engine/EngineFonts/RobotoDistanceField"));
	HUDFont = Font.Object;
}

void AUnrealNetworkingDemoHud::DrawHUD()
{
	Super::DrawHUD();
	...
	if (bWantHUD == true)
	{
		...
		AUnrealNetworkingDemoPawn* Vehicle = Cast<AUnrealNetworkingDemoPawn>(GetOwningPawn());
